...
class Contact implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets label
     *
     * @param string|null $label Optional label for the contact string, such as \"Customer Service\" or \"Pharmacy Fax\".
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value Contact information, as specified by the contact type.
     *
     * @return self
     */
