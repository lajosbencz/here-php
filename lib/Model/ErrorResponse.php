...
class ErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets title
     *
     * @param string $title Human-readable error description
     *
     * @return self
     */
     ...
     * Sets cause
     *
     * @param string|null $cause Human-readable explanation for the error
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action Human-readable action for the user
     *
     * @return self
     */
     ...
     * Sets correlation_id
     *
     * @param string $correlation_id Auto-generated ID univocally identifying this request
     *
     * @return self
     */
     ...
     * Sets request_id
     *
     * @param string $request_id Request identifier provided by the user
     *
     * @return self
     */
